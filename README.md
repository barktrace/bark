...
- source maps, JavaScript rewriting, ProGuard/R8 mappings, ELF/Mach-O/PE/PDB/Breakpad debug files, and reprocessing;
- native minidump ingestion with bounded multi-thread x86/x86-64/ARM64 context parsing, Breakpad CFI, Windows `STACK WIN`, ELF/Mach-O `.eh_frame`, and x86-64/ARM64 Mach-O compact-unwind support;
