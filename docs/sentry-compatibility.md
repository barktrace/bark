...
architecture selection. DWARF symbolication does not yet expand inline frames
...
and procedure symbols and C13 source locations, but PDB inline-site records are
not yet expanded.
