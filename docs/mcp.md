...
| `list_replays`, `analyze_replay`, `list_replay_clicks`, `list_replay_selectors` | Searches replay segments by URL/user, environment, release, issue, or error presence, decodes bounded timelines, and reports dead/rage-click selectors without returning form input values. |
