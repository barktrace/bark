...
func TestSentryCLIWorkflow(t *testing.T) {
	...
	mux.Handle("GET /api/0/users/me/regions/", protected(server.sentryUserRegions))
	...
	mux.Handle("POST /api/0/projects/{org_slug}/{project_slug}/releases/", protected(server.createSentryRelease))
	mux.Handle("GET /api/0/projects/{org_slug}/{project_slug}/releases/{version}/", protected(server.sentryReleaseDetail))
	mux.Handle("PUT /api/0/projects/{org_slug}/{project_slug}/releases/{version}/", protected(server.sentryReleaseDetail))
	mux.Handle("DELETE /api/0/projects/{org_slug}/{project_slug}/releases/{version}/", protected(server.deleteSentryRelease))
	mux.Handle("GET /api/0/projects/{org_slug}/{project_slug}/releases/{version}/files/", protected(server.sentryReleaseArtifacts))
	mux.Handle("POST /api/0/projects/{org_slug}/{project_slug}/releases/{version}/files/", protected(server.sentryReleaseArtifacts))
	mux.Handle("GET /api/0/projects/{org_slug}/{project_slug}/releases/{version}/files/{file_id}/", protected(server.sentryReleaseArtifactDetail))
	mux.Handle("PUT /api/0/projects/{org_slug}/{project_slug}/releases/{version}/files/{file_id}/", protected(server.sentryReleaseArtifactDetail))
	mux.Handle("DELETE /api/0/projects/{org_slug}/{project_slug}/releases/{version}/files/{file_id}/", protected(server.sentryReleaseArtifactDetail))
